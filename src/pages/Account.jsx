...
return (
    <main>
      <h1 className='accountPageHead'>Account Page</h1>
      <section className='boxes__section'>
            <div className="icon-block">
                <h2 className="sectionHeader__h2"><i className="material-icons">local_fire_department</i></h2>
                <h5 className="sectionHeader__h5">Streak</h5>
                <p className="light">You have a streak of 5 days!</p>
            </div>

            <div className="icon-block">
                <h2 className="sectionHeader__h2"><i className="material-icons">list</i></h2>
            ...
            <div className="icon-block">
                <h2 className="sectionHeader__h2"><i className="material-icons"> person</i></h2>
